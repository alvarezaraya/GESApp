extension ProblemaGES {
    static let todos: [ProblemaGES] = [
        ...
        ProblemaGES(
            ...
            categoria: .neurologico,
            nivelIngreso: .ambos,
            descripcion: "Epilepsia en personas de 15 años y más que responde al tratamiento farmacológico. El caso puede abrirse desde APS (Hoja Diaria APS), vía SIC o vía confirmación en especialidad.",
